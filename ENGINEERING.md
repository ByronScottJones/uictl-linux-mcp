...
screenshot/displays/pixel/OCR (mostly done, Phase 4 — screenshot/
displays.list/pixel/ocr implemented and live-verified; clipboard and
ScreenCast+PipeWire not yet — see "Wayland screenshot" section above)**,
feedback + activity log GUI,
